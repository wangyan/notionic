const BLOG = {
  ...
  socialLink: {
    twitter: 'https://twitter.com/wang_yan',
    github: 'https://github.com/wangyan',
  ...
  telegramChannelName: 'WyBlog', // The name of your Telegram channel
  craftConfigShareUrl: 'https://www.craft.do/s/vBa0UopFIvDRu1', // The link to share your craft config
  analytics: {
  ...
  comment: {
    ...
    supaCommentsConfig: {
      supabaseUrl: 'https://zzalcxfuqodsxfxdraav.supabase.co', // The url of your Supabase instance
      supabaseAnonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp6YWxjeGZ1cW9kc3hmeGRyYWF2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTM0Mzg5MzMsImV4cCI6MjAyOTAxNDkzM30.l7YE9rkh8VWpkcEHyjdqbvfEBa1fisx2rsmDETn-VDA' // The anonymous key of your Supabase instance
    },
    utterancesConfig: {
      repo: ''
    }
